...
CKEDITOR.dialog.add( 'number5', function( editor )
      {
		  var root_selection;
		  var root_element;
		  var must_insert;
			  ...
			  onOk : function()
				{
					...
					var element = CKEDITOR.env.ie ?
						editor.document.createElement( '<img src="'+CKEDITOR.basePath+'plugins/oxford_anchor/images/number5.gif" class="number5" dname="' + CKEDITOR.tools.htmlEncode( name ) + '" rel="'+document.getElementById('id_field').value+'" />' ) :
					...
					element.setAttribute( 'class', 'number5' );
					element.setAttribute( 'dname', name );
					element.setAttribute( 'rel', document.getElementById('id_field').value );
					element.setAttribute( 'src', ''+CKEDITOR.basePath+'plugins/oxford_anchor/images/number5.gif' );
					...
					if (must_insert) {
						...
						var element = CKEDITOR.env.ie ?
						editor.document.createElement( '<img src="'+CKEDITOR.basePath+'plugins/oxford_anchor/images/number5_end.gif" class="number5_end" dname="' + CKEDITOR.tools.htmlEncode( name ) + '" rel="'+document.getElementById('id_field').value+'" />' ) :
						editor.document.createElement( 'img' );
						...
						// Set name.
						//element.removeAttribute( '_cke_saved_name' );
						element.setAttribute( 'class', 'number5_end' );
						element.setAttribute( 'dname', name );
						element.setAttribute( 'rel', document.getElementById('id_field').value );
						element.setAttribute( 'src', ''+CKEDITOR.basePath+'plugins/oxford_anchor/images/number5_end.gif' );
						editor.insertElement( element );
					}
					//else
					//{
