...
CKEDITOR.dialog.add( 'number1', function( editor )
      {
		  var root_selection;
		  var root_element;
		  var must_insert;
			  ...
			  onOk : function()
				{
					...
					var element = CKEDITOR.env.ie ?
						editor.document.createElement( '<img src="'+CKEDITOR.basePath+'plugins/oxford_anchor/images/number1.gif" class="number1" dname="' + CKEDITOR.tools.htmlEncode( name ) + '" rel="'+document.getElementById('id_field').value+'" />' ) :
					...
					element.setAttribute( 'class', 'number1' );
					element.setAttribute( 'dname', name );
					element.setAttribute( 'rel', document.getElementById('id_field').value );
					element.setAttribute( 'src', ''+CKEDITOR.basePath+'plugins/oxford_anchor/images/number1.gif' );
					...
					if (must_insert) {
						...
						var element = CKEDITOR.env.ie ?
						editor.document.createElement( '<img src="'+CKEDITOR.basePath+'plugins/oxford_anchor/images/number1_end.gif" class="number1_end" dname="' + CKEDITOR.tools.htmlEncode( name ) + '" rel="'+document.getElementById('id_field').value+'" />' ) :
						editor.document.createElement( 'img' );
						...
						// Set name.
						//element.removeAttribute( '_cke_saved_name' );
						element.setAttribute( 'class', 'number1_end' );
						element.setAttribute( 'dname', name );
						element.setAttribute( 'rel', document.getElementById('id_field').value );
						element.setAttribute( 'src', ''+CKEDITOR.basePath+'plugins/oxford_anchor/images/number1_end.gif' );
						editor.insertElement( element );
					}
					//else
					//{
