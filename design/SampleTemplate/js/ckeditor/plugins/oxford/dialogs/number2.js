...
CKEDITOR.dialog.add( 'number2', function( editor )
      {
		  var root_selection;
		  var root_element;
		  var must_insert;
			  ...
			  onOk : function()
				{
					...
					var element = CKEDITOR.env.ie ?
						editor.document.createElement( '<img src="'+CKEDITOR.basePath+'plugins/oxford_anchor/images/number2.gif" class="number2" dname="' + CKEDITOR.tools.htmlEncode( name ) + '" rel="'+document.getElementById('id_field').value+'" />' ) :
					...
					element.setAttribute( 'class', 'number2' );
					element.setAttribute( 'dname', name );
					element.setAttribute( 'rel', document.getElementById('id_field').value );
					element.setAttribute( 'src', ''+CKEDITOR.basePath+'plugins/oxford_anchor/images/number2.gif' );
