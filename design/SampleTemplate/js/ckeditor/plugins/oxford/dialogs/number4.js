...
CKEDITOR.dialog.add( 'number4', function( editor )
      {
		  var root_selection;
		  var root_element;
		  var must_insert;
			  ...
			  onOk : function()
				{
					...
					var element = CKEDITOR.env.ie ?
						editor.document.createElement( '<img src="'+CKEDITOR.basePath+'plugins/oxford_anchor/images/number4.gif" class="number4" dname="' + CKEDITOR.tools.htmlEncode( name ) + '" rel="'+document.getElementById('id_field').value+'" />' ) :
					...
					element.setAttribute( 'class', 'number4' );
					element.setAttribute( 'dname', name );
					element.setAttribute( 'rel', document.getElementById('id_field').value );
					element.setAttribute( 'src', ''+CKEDITOR.basePath+'plugins/oxford_anchor/images/number4.gif' );
					...
					if (must_insert) {
						...
						var element = CKEDITOR.env.ie ?
						editor.document.createElement( '<img src="'+CKEDITOR.basePath+'plugins/oxford_anchor/images/number4_end.gif" class="number4_end" dname="' + CKEDITOR.tools.htmlEncode( name ) + '" rel="'+document.getElementById('id_field').value+'" />' ) :
						editor.document.createElement( 'img' );
						...
						// Set name.
						//element.removeAttribute( '_cke_saved_name' );
						element.setAttribute( 'class', 'number4_end' );
						element.setAttribute( 'dname', name );
						element.setAttribute( 'rel', document.getElementById('id_field').value );
						element.setAttribute( 'src', ''+CKEDITOR.basePath+'plugins/oxford_anchor/images/number4_end.gif' );
						editor.insertElement( element );
					}
					//else
					//{
