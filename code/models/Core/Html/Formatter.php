		...
		while (true) {
			...
			foreach ($matches as $match) {
				...
				switch ($match[0]) {
					...
					case 'number4_end':
					case 'number5_end':
						$new_match='<img class="'.$match[0].'" dname="'.htmlentities($match[1],ENT_QUOTES,'UTF-8').'" rel="'.$match[2].'" src="/design/SampleTemplate/js/ckeditor/plugins/oxford_anchor/images/'.$match[0].'.gif">';
						break;
					case 'number1':
					case 'number2':
					case 'number3':
